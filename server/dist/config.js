...
const resolveStorageFile = (value) => {
    if (!value) {
        return node_path_1.default.resolve(process.cwd(), 'data', 'market-state.json');
    }
    return node_path_1.default.isAbsolute(value) ? value : node_path_1.default.resolve(process.cwd(), value);
};
exports.config = {
